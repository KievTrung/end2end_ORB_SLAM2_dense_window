...
void Tracking::StereoInitialization()
{
    if(mCurrentFrame.N>500)
    {
        ...
        mpLocalMapper->InsertKeyFrame(pKFini, this->mImRGB, this->mImDepth);
...
bool Tracking::TrackReferenceKeyFrame()
{
    ...
    // somehow in the beginning, BOW of reference frame of frame id 1 is not calculated
    if (mpReferenceKF->mFeatVec.size() == 0){
        mpReferenceKF->ComputeBoW();
        cout << "compute BOW of reference frame" << endl;
    }
